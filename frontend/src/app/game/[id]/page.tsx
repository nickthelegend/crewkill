        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className={`px-4 py-1.5 rounded-full text-[10px] font-black tracking-[0.2em] uppercase ${isLive ? "bg-red-500/20 text-red-500 border border-red-500/30" : "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30"
                  }`}>
          ...
          {isEnded && (
            <motion.div
              ...
              className={`mb-12 p-8 rounded-[2.5rem] border-2 flex flex-col items-center justify-center text-center relative overflow-hidden ${dbGame.crewmatesWon
                    ...
                    {currentRoom?.players.map((p, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`border rounded-xl p-3 flex items-center gap-4 group transition-colors ${isDead
