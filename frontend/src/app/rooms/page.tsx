          ...
          >
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <p className="text-white/40 font-mono tracking-[0.3em] text-[10px] uppercase">
                SYSTEM: <span className="text-emerald-400">ONLINE</span> • SELECT ROOM
              </p>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {filteredGames.length === 0 && (
            ...
            >
              ...
              <h3 className="text-xl font-black text-white italic uppercase tracking-tighter mb-2">No active games</h3>
              <p className="text-white/20 font-mono uppercase tracking-[0.3em] text-[10px] max-w-xs leading-relaxed">There are no matches currently running. Create one to start.</p>
            </motion.div>
          )}
        </div>
      </div>
    ...
    >
      ...
      <div className="space-y-4 mb-10 bg-black/20 p-5 border border-white/5">
        <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em]">
          <span className="text-white/20 font-mono italic text-[9px]">STARTS:</span>
          <span className="text-white">{startAt ? formatDistanceToNow(startAt, { addSuffix: true }) : "UNKNOWN"}</span>
        </div>
        <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em]">
          <span className="text-white/20 font-mono italic text-[9px]">BETTING:</span>
          <span className={isBettingOpen ? "text-emerald-400" : "text-red-500/50"}>
            {isBettingOpen ? "OPEN" : "CLOSED"}
          </span>
        </div>
        <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em]">
          <span className="text-white/20 font-mono italic text-[9px]">TOTAL_POT:</span>
