        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {filteredGames.length === 0 && (
            ...
            >
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-tighter mb-2">No active games</h3>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 mb-10 bg-black/20 p-5 border border-white/5">
        ...
        <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em]">
          <span className="text-white/20 font-mono text-[9px]">TOTAL_POT:</span>
