              ...
              <header className="px-8 py-8 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
                ...
                {!hasActiveRoom && isAuthenticated && (
                  <button
                    ...
                    className="w-10 h-10 bg-cyan-500 text-black flex items-center justify-center hover:bg-cyan-400 transition-all border border-cyan-400 shadow-[0_0_15px_rgba(6,182,212,0.2)]"
                  >
